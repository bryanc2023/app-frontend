...
const PostPageEmpresaG: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <center>
        <p>En esta sección te mostramos todas las publicaciones acerca de Postula. Como empresa gestora puede eliminar cualquier post a pesar de no ser el propietario</p>
      </center>
      <hr className="my-4" />
      ...
      {posts.length === 0 ? (
        <div className="space-y-6">    <h3 className="text-2xl font-semibold mb-4 text-gray-800 text-center">
          Aún no se han publicado ningún post, espera a que los usuarios lo hagan o publica uno.
        </h3>
        </div>
      ) : (
          ...
          <div key={post.id} className="bg-white shadow-lg rounded-lg p-6 border border-gray-300 hover:shadow-xl transition-shadow duration-300">
            ...
            {/* Botón de "Ver más" si hay más de 2 respuestas */}
              ...
              <div className="flex flex-col items-start mt-2 bg-blue-100 p-3 rounded-lg w-40">
                <span className="text-sm text-gray-600 mb-1 font-thin">Acciones del post</span>
...
export default PostPageEmpresaG;
